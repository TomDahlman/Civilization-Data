...
class LeadersControllerTest < ActionController::TestCase
  ...
  test "should create leader" do
    assert_difference('Leader.count') do
      post :create, leader: { civilization_id: @leader.civilization_id, name: @leader.name, notes: @leader.notes }
    end
  ...
  test "should update leader" do
    put :update, id: @leader, leader: { civilization_id: @leader.civilization_id, name: @leader.name, notes: @leader.notes }
    assert_redirected_to leader_path(assigns(:leader))
  end
